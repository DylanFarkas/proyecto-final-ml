...
const Alert = ({ message, type = 'error', duration = 5000, onClose }) => {
  ...
  const getAlertStyles = () => {
    const baseStyles = "fixed top-4 right-4 max-w-md p-4 rounded-lg shadow-lg border z-50 transition-all duration-300 transform";
    ...
    switch (type) {
      ...
      default:
        return `${baseStyles} bg-gray-50 border-gray-200 text-gray-800 dark:bg-gray-900 dark:border-gray-700 dark:text-gray-200`;
    }
  };
